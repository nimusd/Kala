...
public:
    ...
    void setupUi(QMainWindow *KalaMain)
    {
        ...
        gridLayout->addWidget(commentGroupBox, 0, 2, 1, 1);
    ...
    void retranslateUi(QMainWindow *KalaMain)
    {
        ...
        label_3->setText(QCoreApplication::translate("KalaMain", "Comment", nullptr));
        ...
        commentGroupBox->setTitle(QCoreApplication::translate("KalaMain", "Comment:", nullptr));
