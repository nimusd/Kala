...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "6.0.1"
  WORKING_DIRECTORY "C:/c++code/Kala/build/Desktop_Qt_6_10_1_MinGW_64_bit-Debug/_deps/rtaudio-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("6.0.1" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 6.0.1")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/6.0.1")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"6.0.1\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/c++code/Kala/build/Desktop_Qt_6_10_1_MinGW_64_bit-Debug/_deps/rtaudio-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/c++code/Kala/build/Desktop_Qt_6_10_1_MinGW_64_bit-Debug/_deps/rtaudio-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
