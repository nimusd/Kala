...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "6.0.1"
  WORKING_DIRECTORY "C:/c++code/Kala/build/Desktop_Qt_6_10_1_MinGW_64_bit-Release/_deps/rtaudio-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/c++code/Kala/build/Desktop_Qt_6_10_1_MinGW_64_bit-Release/_deps/rtaudio-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/c++code/Kala/build/Desktop_Qt_6_10_1_MinGW_64_bit-Release/_deps/rtaudio-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
