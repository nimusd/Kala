...
public:
    ...
    void setupUi(QMainWindow *KalaMain)
    {
        ...
        sizePolicy2.setHeightForWidth(groupConfig->sizePolicy().hasHeightForWidth());
        groupConfig->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(groupInspector->sizePolicy().hasHeightForWidth());
        groupInspector->setSizePolicy(sizePolicy3);
        ...
        verticalLayoutExpressiveCurves->addWidget(btnExpressiveCurveDelete);
        ...
        sizePolicy4.setHeightForWidth(groupTracks->sizePolicy().hasHeightForWidth());
        groupTracks->setSizePolicy(sizePolicy4);
        ...
        sizePolicy5.setHeightForWidth(scrollAreaMixer->sizePolicy().hasHeightForWidth());
        scrollAreaMixer->setSizePolicy(sizePolicy5);
        ...
        sizePolicy6.setHeightForWidth(spinScaleMarker->sizePolicy().hasHeightForWidth());
        spinScaleMarker->setSizePolicy(sizePolicy6);
        ...
        sizePolicy7.setHeightForWidth(labelScaleDisplay->sizePolicy().hasHeightForWidth());
        labelScaleDisplay->setSizePolicy(sizePolicy7);
        ...
        sizePolicy6.setHeightForWidth(btnScaleEdit->sizePolicy().hasHeightForWidth());
        btnScaleEdit->setSizePolicy(sizePolicy6);

        horizontalLayout_5->addWidget(btnScaleEdit);

        btnScaleAdd = new QPushButton(groupScale);
        btnScaleAdd->setObjectName("btnScaleAdd");
        sizePolicy6.setHeightForWidth(btnScaleAdd->sizePolicy().hasHeightForWidth());
        btnScaleAdd->setSizePolicy(sizePolicy6);
        ...
        sizePolicy6.setHeightForWidth(spinTempoMarker->sizePolicy().hasHeightForWidth());
        spinTempoMarker->setSizePolicy(sizePolicy6);
        ...
        sizePolicy7.setHeightForWidth(labelTempoDisplay->sizePolicy().hasHeightForWidth());
        labelTempoDisplay->setSizePolicy(sizePolicy7);
        ...
        sizePolicy6.setHeightForWidth(btnTempoEdit->sizePolicy().hasHeightForWidth());
        btnTempoEdit->setSizePolicy(sizePolicy6);

        horizontalLayout_Tempo->addWidget(btnTempoEdit);

        btnTempoAdd = new QPushButton(groupTempo);
        btnTempoAdd->setObjectName("btnTempoAdd");
        sizePolicy6.setHeightForWidth(btnTempoAdd->sizePolicy().hasHeightForWidth());
        btnTempoAdd->setSizePolicy(sizePolicy6);
    ...
    void retranslateUi(QMainWindow *KalaMain)
    {
        ...
        actionUndo_Ctrl_Z->setShortcut(QCoreApplication::translate("KalaMain", "Ctrl+Z", nullptr));
#endif // QT_CONFIG(shortcut)
        actionRedo_Ctrl_Y->setText(QCoreApplication::translate("KalaMain", "Redo (Ctrl+Y)", nullptr));
#if QT_CONFIG(shortcut)
        actionRedo_Ctrl_Y->setShortcut(QCoreApplication::translate("KalaMain", "Ctrl+Y", nullptr));
#endif // QT_CONFIG(shortcut)
